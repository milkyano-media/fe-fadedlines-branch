...
const InstagramSection: React.FC<InstagramSectionProps> = ({ instagram_images_desktop, instagram_images_mobile }) => {
    ...
    return (
        <section className="md:h-screen flex flex-col justify-center items-center pt-24 relative z-10">
            <div className="w-full px-4 md:px-0 md:w-10/12 justify-center flex flex-col z-10 relative items-center">
                ...
                <div className="flex flex-col md:hidden gap-4 h-1/3 w-full z-20 bg-black">
                    {instagram_images_desktop.map((image, index) => (
                        <img
                            ...
                            height={500}
                            className={`h-[10em]  ${
                                index === instagram_images_mobile.length - 1 ? "h-[300px]" : "h-2/12"
                ...
                <div className="self-center py-12">
                    <Button>
                        {customize ? <Link to={bookLink}>BOOK NOW</Link> : <a href={squareLink}>BOOK NOW</a>}
                    </Button>
                </div>
            </div>
        </section>
