            ...
            <div className="bg-concrete-dark-90 flex flex-col text-stone-50 bg-black w-full relative tracking-wider">
                                        ...
                                        <FormItem className="w-full flex flex-col justify-center items-center rounded-lg p-3 bg-[#262626] placeholder-[#B3E7C9]">
                                            ...
                                            <FormControl>
                                                <Input
                                                    ...
                                                    className="placeholder:text-[#8f5b24] bg-transparent focus-visible:outline-none"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage />
                ...
                <section ref={ref}>
                    <div className=" w-full flex justify-center  relative">
                        <div className="h-[10rem] w-[1px] bg-[#663500] z-0" />
                        <motion.div
                            className="absolute h-[10rem] w-[2px] bg-gradient-to-b from-[#653501] to-[#ff8400] shadow-[0px_0px_70px_2px_#ff8400] origin-top z-10"
                            style={{ scaleY }}
                        />
                    </div>
                </section>
                <section className="w-1/2 flex flex-col md:flex-row self-center justify-center items-center relative z-30 py-32 pb-[20rem] gap-8 font-bold text-center">
                    ...
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <h4>
                            <span className="text-transparent bg-gradient-to-r from-[#ff8400] to-[#ffdab3] bg-clip-text">
                                After
                            </span>{" "}
                            working with us{" "}
                        </h4>
