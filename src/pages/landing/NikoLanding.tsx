...
import cardOne from "@/assets/landing/reviews/niko/card1.svg";
import cardTwo from "@/assets/landing/reviews/niko/card2.svg";
import cardThree from "@/assets/landing/reviews/niko/card3.svg";
import cardFour from "@/assets/landing/reviews/niko/card4.svg";
...
export default function NikoLanding() {
  ...
  const description =
    "Dedicated to the fine art of barbering, I offer expert advice and top-tier services to keep you looking sharp and feeling great.";
  ...
  return (
    <LandingLayout>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Niko Fadelines BEST BARBER IN MELBOURNE"
        />
        <meta
